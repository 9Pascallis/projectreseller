        ...
        <form action="/insertdataadmin" method="POST">
            ...
            <div class="row" style="margin-left: 20px; margin-right: 20px">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="nama_lengkap_admin" value="{{old('nama_lengkap_admin')}}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="email" name="email_admin" value="{{old('email_admin')}}"
                            class="form-control @error('email_admin') is-invalid @enderror me-2" required>
                        @error('email_admin')
                        <span class="invalid-feedback">{{ $message}}</span>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="no_telp_admin" value="{{old('no_telp_admin')}}" class="form-control"
                            required>
                        @error('no_telp_admin')
                        <span class="invalid-feedback">{{ $message}}</span>
                        @enderror
