...
@section('content')
	<div class="card">
		<div class="card-body">
			<!-- JUDUL -->
			<h5 class="mb-0 text-uppercase text-center">Edit Admin</h5><hr><br>
			<!-- JUDUL END-->
			...
			<form action="/updateadmin-{{ $admin->id }}" method="POST">
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
					<input type="text" name="nama_lengkap_admin" class="form-control" style="text-transform:uppercase" value="{{ $admin->nama_lengkap_admin}}">
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
					<input type="email" name="email_admin" class="form-control @error('email_admin') is-invalid @enderror me-2" value="{{ $admin->email_admin}}">
					@error('email_admin')
						<span class="invalid-feedback">{{ $message}}</span>
					@enderror
				</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
					<input type="number" name="no_telp_admin" class="form-control" value="{{ $admin->no_telp_admin}}">
					@error('no_telp_admin')
						<span class="invalid-feedback">{{ $message}}</span>
					@enderror
					</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
					<input type="text" name="password_admin" class="form-control" value="{{ $admin->password_admin}}">
