...
<div class="card">
    <div class="card-body">
        <!--JUDUL-->
        <h5 class="mb-0 text-uppercase text-center">Edit Jenis Produk</h5>
        <hr><br>
        <!--JUDUL END-->
        ...
        <form action="/updatejenisproduk-{{$jenis_produk->id}}" method="POST">
            ...
            <div class="row" style="margin-left: 20px; margin-right: 20px">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="nama_jenis_produk"
                            class="form-control @error('nama_jenis_produk') is-invalid @enderror me-2"
                            style="text-transform:uppercase" value="{{$jenis_produk->nama_jenis_produk}}" required>
