...
@section('content')
	<div class="card">
		<div class="card-body">
			<!-- JUDUL -->
			<h5 class="mb-0 text-uppercase text-center">Tambah User</h5><hr><br>
			<!-- JUDUL END-->
			...
			<form action="/insertdatauser" method="POST">
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
					<input type="text" class="form-control" name="no_telp_user" value="{{old('no_telp_user')}}" required>
					@error('no_telp_user')
						<span class="invalid-feedback">{{ $message}}</span>
					@enderror
					</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
					<input type="text" class="form-control" name="alamat_user" value="{{old('alamat_user')}}" required>
					@error('alamat_user')
						<span class="invalid-feedback">{{ $message}}</span>
					@enderror
					</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
					<input type="text" class="form-control" name="provinsi_user" value="{{old('provinsi_user')}}" required>
					@error('provinsi_user')
						<span class="invalid-feedback">{{ $message}}</span>
					@enderror
					</div>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
					<input type="text" class="form-control" name="kecamatan_user" value="{{old('kecamatan_user')}}" required>
				...
				<div class="row mb-3">
					...
					<div class="col-sm-9">
					<input type="text" class="form-control" name="kode_pos_user" value="{{old('kode_pos_user')}}" required>
					@error('kode_pos_user')
						<span class="invalid-feedback">{{ $message}}</span>
					@enderror
					</div>
