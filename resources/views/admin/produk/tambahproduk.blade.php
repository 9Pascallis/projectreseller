...
@section('content')
	<div class="card">
		<div class="card-body">
			<!-- JUDUL -->
			<h5 class="mb-0 text-uppercase text-center">Tambah Produk</h5><hr><br>
			<!-- JUDUL END -->
			...
			<form action="/insertdataproduk" method="POST" enctype="multipart/form-data">
				...
				<div class="row" style="margin-left: 20px; margin-right: 20px">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-8">
							<textarea class="form-control" name="deskripsi_produk" required >{{{ Request::old('deskripsi_produk') }}}</textarea>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="harga_produk" id="dengan-rupiah" value="{{old('harga_produk')}}" required>
							@error('harga_produk')
								<span class="invalid-feedback">{{ $message}}</span>
							@enderror
						</div>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-8">
							<input type="number" class="form-control" name="total_stok_produk" value="{{old('total_stok_produk')}}" required>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-8">
							<input type="file" id="foto_utama_produk" class="form-control" name="foto_utama_produk" required>
