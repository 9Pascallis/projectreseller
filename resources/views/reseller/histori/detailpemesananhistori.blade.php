        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-10">
                <div class="card">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <div class="col">
                                    ...
                                    {{-- <div class="">No Invoice: {{$pemesanan->invoice}}</div> --}}
                                </div>
                            </div>
                    ...
                    <div class="container">
                        {{-- <div class="text-center mt-30"><img src="{{asset('assets_reseller/img/core-img/logoorange.png')}}" class="text-center"
                            width="180px" style="padding-bottom: 10px" alt=""></div>
                        <div class="text-center"><h5 class="text-center">DETAIL PEMESANAN</h5></div> --}}
                        <div class="text-center"><h5 class="mb-1"><b>INVOICE</b></h5></div>
                        <div class="text-center"><h6 class="mb-1">No: <b>{{$pemesanan->invoice}}</b></h6></div>
                        <div class="text-center">Tanggal Pemesanan: <?php echo date('d-m-Y', strtotime($pemesanan->tanggal_pemesanan));?></div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Rp.
                                            {{ number_format($item->item_produk->produk->harga_produk) }}</td>
