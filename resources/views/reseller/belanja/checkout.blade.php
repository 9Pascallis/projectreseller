                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11 mb-3">
                                ...
                                <input type="number" name="kode_pos_penerima" class="form-control"
                                    id="kode_pos_penerima" value="{{ $user->kode_pos }}" required>
                            </div>
                            <!-- KIRIM KE ALAMAT LAIN -->
                            <div class="col-md-11 mt-30 mb-30">

                                <button class="btn essence-btn bg-dark" style="height: 50px" type="button"
                                    onclick="resetFields(); resetAddress();">Kirim Ke Alamat Lain</button>
                                <p style="padding: 5px">*Jika tombol terpencet dan tidak jadi kirim ke alamat lain,
                                    refresh kembali halaman ini</p>
                            </div>
                        </div>
                    ...
                    <div class="order-details-confirmation">
                        ...
                        <ul class="order-details-form">
                            ...
                            <li><span><b>Total Harga</b></span> <span><b>Rp.
                                        {{ number_format($pemesanan->total_harga_pemesanan, 0, ',', '.') }}</b></span>
                            </li>
                            @endif
